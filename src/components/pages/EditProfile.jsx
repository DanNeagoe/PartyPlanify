...
export const EditProfile = () => {
  ...
  const updateUserProfileImage = async (imageUrl) => {
    if (image !== "https://firebasestorage.googleapis.com/v0/b/partyplanify.appspot.com/o/defaultPhoto.webp?alt=media&token=ac09587e-62e2-4b03-bb44-6ce0cb3ec7cb") {
      ...
      <div className="containerEditProfile">
        <div className="containerEditProfileRight">
          <img className="containerEditProfilePhoto"
            src={image !== "https://firebasestorage.googleapis.com/v0/b/partyplanify.appspot.com/o/defaultPhoto.webp?alt=media&token=ac09587e-62e2-4b03-bb44-6ce0cb3ec7cb" ? image : "https://firebasestorage.googleapis.com/v0/b/partyplanify.appspot.com/o/defaultPhoto.webp?alt=media&token=ac09587e-62e2-4b03-bb44-6ce0cb3ec7cb"
            }
          />
          ...
          <div className="photoButtons">
            ...
            <button className='deletePhoto' onClick={() => updateUserProfileImage("https://firebasestorage.googleapis.com/v0/b/partyplanify.appspot.com/o/defaultPhoto.webp?alt=media&token=ac09587e-62e2-4b03-bb44-6ce0cb3ec7cb")}>Șterge Poza</button>
          </div>
          <h4>Numele</h4>
